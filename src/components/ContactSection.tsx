...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="relative py-32 md:py-40 px-6 scroll-mt-28 sm:scroll-mt-32 border-b-4 border-foreground bg-background">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="space-y-8">
            ...
            <div className="pt-4">
              <h4 className="text-sm font-bold mb-4 uppercase">Find me on</h4>
          ...
          <div className="bg-card border-2 border-foreground p-6 hover:shadow-lg hover:translate-x-1 hover:translate-y-1 transition-all duration-200">
            <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
              <div>
                ...
                <Input
                  id="name"
                  {...register('name')}
                  className="bg-background border-2 border-foreground text-xs"
              ...
              <div>
                <Label htmlFor="email" className="mb-2 text-xs font-bold">
                  Email
                </Label>
                <Input
                  id="email"
              ...
              <div>
                <Label htmlFor="message" className="mb-2 text-xs font-bold">
                  Message
                </Label>
                <Textarea
                  id="message"
                  {...register('message')}
                  rows={4}
                  className="bg-background border-2 border-foreground resize-none text-xs"
              ...
              <Button 
                className="retro-button-filled w-full text-xs" 
                type="submit"
                disabled={isSubmitting}
              >
                {isSubmitting ? (
...
const ContactItem = ({
  ...
  <div className="flex items-start gap-3 group">
    <div className="p-2 border-2 border-foreground text-foreground mt-1">
      {icon}
    </div>
    <div>
      <p className="text-xs text-foreground font-bold uppercase">{label}</p>
      {href ? (
        <a
          href={href}
          className="text-foreground hover:underline transition-all duration-200 text-sm"
        >
          {value}
        </a>
      ) : (
