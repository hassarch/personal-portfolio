      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="space-y-6 text-center">
            ...
            <div className={`grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 pt-6 transition-all duration-700 delay-300 ${
              contentVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}>
...
const StatCard = ({
  ...
  <div className="glass-card p-4 rounded-xl text-center hover-glow transition-all duration-300 hover:scale-105 cursor-default">
