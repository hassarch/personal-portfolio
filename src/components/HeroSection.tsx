...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 py-32 md:py-40 pt-32 border-b-4 border-foreground">
      <div className="max-w-5xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <p className="text-foreground font-bold text-sm mb-4 tracking-widest uppercase animate-fade-in-up opacity-0" style={{ animationDelay: '0.2s', animationFillMode: 'forwards' }}>
              Hello.
            </p>
            ...
            <BlurText
              ...
              stepDuration={0.6}
              className="text-5xl md:text-6xl font-bold mb-6 text-foreground tracking-tight leading-tight"
            />

            <p className="text-foreground text-sm md:text-base max-w-2xl mb-8 leading-relaxed font-mono animate-fade-in-up opacity-0" style={{ animationDelay: '0.8s', animationFillMode: 'forwards' }}>
              Computer Science student & developer. I build clean, user-centric web apps using modern frontend tech.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 mb-8 animate-fade-in-up opacity-0" style={{ animationDelay: '1s', animationFillMode: 'forwards' }}>
            ...
            <div className="flex gap-3 animate-fade-in-up opacity-0" style={{ animationDelay: '1.2s', animationFillMode: 'forwards' }}>
          ...
          <div className="hidden md:flex items-center justify-center">
            <div className="w-full aspect-square border-4 border-foreground bg-secondary flex items-center justify-center">
              <div className="text-center">
                <div className="text-6xl mb-4">💻</div>
                <p className="font-bold text-sm">Web Developer</p>
              </div>
            </div>
          </div>
        </div>
